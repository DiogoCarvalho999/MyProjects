...
public class FirstRoom extends Room implements KeyboardHandler {
    ...
    public void createKeyboardEvents() {
        ...
        KeyboardEvent keyboardEventE = new KeyboardEvent();
    ...
    public void keyPressed(KeyboardEvent keyboardEvent) {
        switch (keyboardEvent.getKey()) {
            case KeyboardEvent.KEY_SPACE:
                for (Chest chest : chestArray) {
                    if (verifyIntersection(chest)) {
                        chest.open(true);
                        player.getPlayerIcon().delete();
                        player.getPlayerIcon().draw();
                    }
                }
                if (verifyIntersection(this.door) && this.player.isHasKey()) {
                    this.door.open(true);
                    player.getPlayerIcon().delete();
                    player.getPlayerIcon().draw();
                }
            ...
            case KeyboardEvent.KEY_E:
                if (verifyIntersection(chestArray[chestWithKey]) && chestArray[chestWithKey].isOpen()) {
            ...
            case KeyboardEvent.KEY_F:
                if (verifyIntersection(door) && this.door.isOpen()) {
